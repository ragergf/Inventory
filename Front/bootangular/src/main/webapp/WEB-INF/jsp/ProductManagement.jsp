                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.product.name" name="pname" class="username form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.product.description" class="form-control input-sm" placeholder="Enter the description. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.product.price" class="form-control input-sm" placeholder="Enter your description. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="p in ctrl.products">
                              ...
                              <td><span ng-bind="u.barcode"></span></td>
