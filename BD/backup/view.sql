...
INSERT INTO `company` VALUES (1,'Farmacia Rapha');
...
CREATE TABLE `company_department` (
  ...
  KEY `fk_company_has_department_department1_idx` (`department_id`),
  KEY `fk_company_has_department_company1_idx` (`company_id`),
  CONSTRAINT `fk_company_has_department_company1` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`),
  CONSTRAINT `fk_company_has_department_department1` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`)
...
CREATE TABLE `inventory` (
  ...
  KEY `fk_inventory_company1_idx` (`company_id`),
  CONSTRAINT `FKp7gj4l80fx8v0uap3b2crjwp5` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `fk_inventory_company1` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
...
INSERT INTO `inventory` VALUES (1,1,'2018-10-27 16:01:26','inicial',30.00,0,1),(2,1,'2018-10-23 20:13:17','inicial',100.00,0,2),(3,1,'2018-10-23 20:27:14','inicial',80.00,0,3),(4,1,'2018-10-24 18:53:59','inicial',80.00,0,4),(5,1,'2018-10-24 19:12:50','inicial',85.00,0,5),(6,1,'2018-10-24 19:14:43','inicial',110.00,0,6),(7,1,'2018-10-24 19:18:13','inicial',90.00,0,7),(8,1,'2018-10-24 19:20:03','inicial',30.00,0,8),(9,1,'2018-10-24 19:21:39','inicial',80.00,0,9),(10,1,'2018-10-24 19:22:57','inicial',110.00,0,10),(11,1,'2018-10-24 19:25:21','inicial',150.00,0,11),(12,1,'2018-10-24 19:29:56','inicial',20.00,0,12),(13,1,'2018-10-24 19:33:08','inicial',70.00,0,13),(14,1,'2018-10-24 19:36:43','inicial',20.00,0,14),(15,1,'2018-10-24 19:38:57','inicial',100.00,0,15),(16,1,'2018-10-24 19:44:00','inicial',15.00,0,16),(17,1,'2018-10-24 19:45:03','inicial',20.00,0,17),(18,1,'2018-10-24 19:49:56','inicial',40.00,0,18),(19,1,'2018-10-26 18:20:13','inicial',60.00,0,19),(20,1,'2018-10-26 18:25:11','inicial',30.00,0,20),(21,1,'2018-10-26 18:27:52','inicial',50.00,0,21),(22,1,'2018-10-26 18:29:35','inicial',45.00,0,22),(23,1,'2018-10-26 18:33:28','inicial',40.00,0,23),(24,1,'2018-10-26 18:37:10','inicial',30.00,0,24),(25,1,'2018-10-26 18:35:49','inicial',20.00,0,25),(26,1,'2018-10-26 18:41:27','inicial',40.00,0,26),(27,1,'2018-10-26 18:43:36','inicial',35.00,0,27),(28,1,'2018-10-26 18:45:36','inicial',35.00,0,28),(29,1,'2018-10-26 18:48:36','inicial',90.00,0,29),(30,1,'2018-10-26 18:50:08','inicial',60.00,0,30),(31,1,'2018-10-26 18:51:46','inicial',65.00,0,31),(32,1,'2018-10-26 18:52:51','inicial',40.00,0,32),(33,1,'2018-10-26 19:02:35','inicial',27.00,0,33),(34,1,'2018-10-26 19:02:02','inicial',40.00,0,34),(35,1,'2018-10-26 19:04:17','inicial',22.00,0,35),(36,1,'2018-10-26 19:06:06','inicial',25.00,0,36),(37,1,'2018-10-26 19:07:21','inicial',35.00,0,37),(38,1,'2018-10-26 19:13:15','inicial',30.00,0,38),(39,1,'2018-10-26 19:15:23','inicial',40.00,0,39),(40,1,'2018-10-26 19:20:44','inicial',45.00,0,40),(41,1,'2018-10-26 19:22:44','inicial',40.00,0,41),(42,1,'2018-10-27 12:56:49','inicial',65.00,0,42),(43,1,'2018-10-27 12:59:37','inicial',65.00,0,43),(44,1,'2018-10-27 13:00:58','inicial',70.00,0,44),(45,1,'2018-10-27 13:02:00','inicial',70.00,0,45),(46,1,'2018-10-27 13:03:59','inicial',75.00,0,46),(47,1,'2018-10-27 13:05:30','inicial',90.00,0,47),(48,1,'2018-10-27 13:14:02','inicial',35.00,0,48),(49,1,'2018-10-27 13:18:06','inicial',30.00,0,49),(50,1,'2018-10-27 13:20:03','inicial',40.00,0,50),(51,1,'2018-10-27 13:26:56','inicial',45.00,0,51),(52,1,'2018-10-27 13:26:34','inicial',40.00,0,52),(53,1,'2018-10-27 13:28:15','inicial',25.00,0,53),(54,1,'2018-10-27 13:29:49','inicial',25.00,0,54),(55,1,'2018-10-27 13:32:50','inicial',115.00,0,55),(56,1,'2018-10-27 13:33:33','inicial',115.00,0,56),(57,1,'2018-10-27 13:36:04','inicial',65.00,0,57),(58,1,'2018-10-27 13:37:49','inicial',70.00,0,58),(59,1,'2018-10-27 13:38:33','inicial',70.00,0,59),(60,1,'2018-10-27 13:40:47','inicial',80.00,0,60),(61,1,'2018-10-27 13:41:39','inicial',125.00,0,61),(62,1,'2018-10-27 13:42:27','inicial',85.00,0,62),(63,1,'2018-10-27 13:44:28','inicial',60.00,0,63),(64,1,'2018-10-27 14:08:03','inicial',50.00,0,64),(65,1,'2018-10-27 14:10:04','inicial',85.00,0,65),(66,1,'2018-10-27 14:11:01','inicial',80.00,0,66),(67,1,'2018-10-27 14:16:56','inicial',20.00,0,67),(68,1,'2018-10-27 14:19:18','inicial',20.00,0,68),(69,1,'2018-10-27 14:24:51','inicial',25.00,0,69),(70,1,'2018-10-27 14:27:36','inicial',40.00,0,70),(71,1,'2018-10-27 14:32:52','inicial',60.00,0,71),(72,1,'2018-10-27 14:36:05','inicial',50.00,0,72),(73,1,'2018-10-27 14:37:40','inicial',50.00,0,73),(74,1,'2018-10-27 14:42:02','inicial',50.00,0,74),(75,1,'2018-10-27 14:44:43','inicial',80.00,0,75),(76,1,'2018-10-27 14:46:22','inicial',60.00,0,76),(77,1,'2018-10-27 14:48:36','inicial',80.00,0,77),(78,1,'2018-10-27 14:49:53','inicial',40.00,0,78),(79,1,'2018-10-27 14:50:38','inicial',40.00,0,79),(80,1,'2018-10-27 14:52:34','inicial',40.00,0,80),(81,1,'2018-10-27 14:54:33','inicial',200.00,0,81),(82,1,'2018-10-27 14:59:51','inicial',70.00,0,82),(83,1,'2018-10-27 15:01:17','inicial',50.00,0,83),(84,1,'2018-10-27 15:02:54','inicial',45.00,0,84),(85,1,'2018-10-27 15:04:24','inicial',100.00,0,85),(86,1,'2018-10-27 15:08:05','inicial',60.00,0,86),(87,1,'2018-10-27 15:15:16','inicial',50.00,0,87),(88,1,'2018-10-27 15:19:11','inicial',25.00,0,88),(89,1,'2018-10-27 15:21:45','inicial',50.00,0,89),(90,1,'2018-10-27 16:00:11','inicial',65.00,0,90),(91,1,'2018-10-27 16:01:30','inicial',50.00,0,91);
...
CREATE TABLE `sale` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_sale_sale_status1_idx` (`sale_status_id`),
  KEY `fk_sale_company1_idx` (`company_id`),
  KEY `idx_sale_date` (`sale_date`),
  CONSTRAINT `fk_sale_company1` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`),
  CONSTRAINT `fk_sale_sale_status1` FOREIGN KEY (`sale_status_id`) REFERENCES `sale_status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sale_detail` (
  `sec` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_sale_detail_inventory1_idx` (`inventory_id`),
  CONSTRAINT `fk_sale_detail_inventory1` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`id`),
  CONSTRAINT `fk_sale_detail_sale1` FOREIGN KEY (`sale_id`) REFERENCES `sale` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_status` VALUES (1,'Completed','The transaction is completed'),(2,'Canceled','The transaction has canceled');
...
/*!50001 VIEW `daily_summary` AS select `sale`.`sale_date` AS `sale_date`,sum(`sale`.`total`) AS `total`,`sale`.`company_id` AS `company_id` from `sale` where (`sale`.`sale_status_id` = 1) group by `sale`.`sale_date`,`sale`.`company_id` */;
...
-- Dump completed on 2018-11-28  6:22:30
